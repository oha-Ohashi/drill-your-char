...
export default {
  data() {
    return {
      url_nums: [null, null],
      nums_A: ["/tegaki01/0011.png", "/tegaki01/0012.png"],
      url_operator: null,
      nums_B: ["/tegaki01/0011.png", "/tegaki01/0012.png"],
  ...
  methods: {  
    change() {
      ...
      this.url_nums[0] = "/tegaki01/"+ String(nums[0]).padStart(4, '0') +".png";  
      this.nums_B = GetUrlsFromNumber(nums[1]);
      this.url_nums[1] = "/tegaki01/"+ String(nums[1]).padStart(4, '0') +".png";  

      //this.current = this.list[Math.floor(Math.random() * this.list.length)];
      // 足し算と引き算が 50:50
      this.url_operator = isPlus ? "/tegaki01/0020.png" : "/tegaki01/0021.png";
    },
  },
};
